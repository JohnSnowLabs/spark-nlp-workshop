...
def start():
    builder = SparkSession.builder \
        ...
        .config("spark.jars", 
                "gs://spark-healthcare-nlp/jars/spark-nlp-jsl-6.0.0.jar,"
                "gs://spark-healthcare-nlp/jars/spark-nlp-assembly-6.0.0.jar")
...
chunkerMapper = ChunkMapperModel.load("gs://spark-healthcare-nlp/models/drug_brandname_ndc_mapper_en")\
      .setInputCols(["chunk"])\
      .setOutputCol("ndc")\
