...
The script we'll use for this setup is [`jsl_emr_bootstrap.sh`](./jsl_emr_bootstrap.sh) which is contained in this folder.


You need to put your credentials into [`jsl_emr_bootstrap.sh`](./jsl_emr_bootstrap.sh) file <br/>
