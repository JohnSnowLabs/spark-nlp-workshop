...
sudo python3 -m pip install johnsnowlabs==5.1.0

sudo -E python3 -c "from johnsnowlabs import nlp;nlp.install(med_license='<license_key>',aws_access_key='<aws_access_key>',aws_key_id='<aws_key>', spark_nlp=True, nlp=True, visual=False, hardware_platform='cpu')"
