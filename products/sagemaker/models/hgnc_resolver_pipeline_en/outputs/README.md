...
- **all_k_codes**: All the codes found found in ATC taxonomy, separated by three colons (`:::`), sorted from most to least similar.
- **all_k_resolutions**: All the terms found in ATC taxonomy, separated by three colons (`:::`), sorted from most to least similar.
