    ...
    [
      {
        ...
        "domain_class": ["Concept_Class1", "Concept_Class2", ...],
...
- **domain_class**: A list of concept class IDs for the resolutions in `all_resolutions`.
