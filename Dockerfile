...
RUN pip3 install --no-cache-dir notebook==5.* numpy pyspark==2.4.3 spark-nlp==2.3.4 pandas mlflow Keras scikit-spark scikit-learn scipy matplotlib pydot tensorflow graphviz
