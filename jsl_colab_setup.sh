...
#: ${SPARK_NLP_LICENSE:?missing -l (SPARK_NLP_LICENSE) } ${AWS_ACCESS_KEY_ID:?missing -i (AWS_ACCESS_KEY_ID)} ${AWS_SECRET_ACCESS_KEY:?Missing -k (AWS_SECRET_ACCESS_KEY) ${JSL_SECRET:?Missing -c (JSL_SECRET)}
